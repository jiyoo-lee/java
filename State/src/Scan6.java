...
public class Scan6 {
	...
	public static void main(String[] args) {
		//순서: 불러오고 나서 뭘 입력할건지 출력하고 사용자가 입력한 값을 변수로 변환한다.
		 ...
		 * jung : j1234
		 * su : ssh
		 * 해당 아이디 외에 나머지는 가입 되지 않은 사용자입니다.라고 출력하세요
		 * 또한 패스워드가 틀릴경우 회원정보를 다시 확인하세요라고 출력합니다.
		 * 아이디 및 패스워드가 모두 맞을 경우 로그인 되셨습니다라고  출력합니다.
		*/
